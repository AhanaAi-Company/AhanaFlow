...
#
# AhanaFlow State Engine Codec — Open-Core distribution layer.
#
...
try:
    from ahana_codec import compress_wal as _pro_compress_wal
...
def decompress(data: bytes) -> bytes:
    """Decompress a WAL record.  Auto-detects format (zstd vs gzip)."""
    if _PRO_AVAILABLE:
